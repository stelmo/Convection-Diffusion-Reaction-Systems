...
It is prudent (in practice a necessity) to attempt to model the temperature profile of the reactor given that we will be dealing with forward, exothermic, irreversible reactions exclusively in this project. 
