...
\begin{abstract}
This project aims to introduce the reader to the use of the Finite Element Method for solving typical Chemical Engineering reactor design problems. The convection, diffusion and reaction equation is derived (along with the corresponding energy balance). Using this, unsteady tubular reactor problems are then posed and solved using the Finite Element Method.
\end{abstract}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.5]{./pics/p1_mass}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.3]{./pics/p1_unstable}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.5]{./pics/p2_mass}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.5]{./pics/p3_mass}
\caption{Mass matrix} 
\label{fig_p3mass}
\end{figure}
...
\begin{figure}[H] 
\centering
\includegraphics[scale=0.3]{./pics/p4_mass}
\caption{Mass matrix shape} 
\label{fig_p4mass}
\end{figure}
